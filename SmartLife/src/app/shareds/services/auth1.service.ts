...
export function getClientSettings(): UserManagerSettings {
  return {
      ...
      redirect_uri: 'http://103.56.157.138:8083/smartlife',
      post_logout_redirect_uri: 'http://103.56.157.138:8083/smartlife',
      response_type:"id_token token",
      scope:"openid profile email api.read",
      filterProtocolClaims: true,
      loadUserInfo: true,
      automaticSilentRenew: true,
      silent_redirect_uri: 'http://103.56.157.138:8083/smartlife/silent-refresh.html'
  };
}
